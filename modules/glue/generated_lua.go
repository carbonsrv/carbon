...
func mainglue_lua() (*asset, error) {
	...
	info := bindata_file_info{name: "MainGlue.lua", size: 4636, mode: os.FileMode(420), modTime: time.Unix(1438888417, 0)}
