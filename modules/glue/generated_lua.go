...
func mainglueLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "MainGlue.lua", size: 6510, mode: os.FileMode(420), modTime: time.Unix(1447732487, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
